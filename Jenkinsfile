                ...
                stage('Fetch hexo barnch') {
                    ...
                    steps {
                        dir('hexo-branch') {
                            ...
                            git branch: 'hexo', credentialsId: 'c5a66b90-ed73-4bd6-b247-abd92b2e1572', url: 'git@github.com:huangyisan/myblog.git'
                        }
                    }
                ...
                stage('Fetch master branch') {
                    steps{
                        dir('master-branch') {
                            ...
                            git branch: 'master', credentialsId: 'c5a66b90-ed73-4bd6-b247-abd92b2e1572', url: 'git@github.com:huangyisan/myblog.git'
                        }
                    }
                }
            }
